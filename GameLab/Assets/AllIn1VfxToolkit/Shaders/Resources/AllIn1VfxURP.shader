Shader "AllIn1Vfx/AllIn1VfxURP"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half3 GetWorldSpaceViewDir(half3 positionWS)
            {
            ...
            inline half4 ComputeGrabScreenPos(half4 pos)
			{
            ...
            half4 frag(v2f i) : SV_Target
            {
            	...
            	half3 distortCol = SampleSceneColor(i.screenCoord.xy);
            	#if DISTORTONLYBACK_ON
            	...
            	col.rgb = lerp(lerp(col.rgb, saturate(distortCol.rgb), _DistortionBlend), lerp(col.rgb, SampleSceneColor((originalScreenCoord / originalScreenCoord.w).xy).rgb, _DistortionBlend), frontMask);
            	#else
